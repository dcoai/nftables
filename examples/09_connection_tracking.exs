...
defmodule ConnectionTrackingExample do
  ...
  defp ct_state_filtering(pid) do
    ...
    RuleBuilder.new(pid, "filter", "FORWARD", family: :inet)
    ...
    RuleBuilder.new(pid, "filter", "INPUT", family: :inet)
  ...
  defp ct_direction_tracking(pid) do
    ...
    RuleBuilder.new(pid, "mangle", "PREROUTING", family: :inet)
    |> RuleBuilder.match_ct_direction(:original)
    |> RuleBuilder.match_iif("lan0")
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
    ...
    RuleBuilder.new(pid, "mangle", "PREROUTING", family: :inet)
    |> RuleBuilder.match_ct_direction(:reply)
    |> RuleBuilder.match_iif("wan0")
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
    ...
    RuleBuilder.new(pid, "mangle", "PREROUTING", family: :inet)
    |> RuleBuilder.match_ct_direction(:reply)
    |> RuleBuilder.match_connmark(@mark_wan0)
    |> RuleBuilder.match_iif("wan1")
    |> RuleBuilder.log("ASYMMETRIC-ROUTE: ")
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
  ...
  defp ct_status_monitoring(pid) do
    ...
    RuleBuilder.new(pid, "filter", "FORWARD", family: :inet)
    |> RuleBuilder.match_ct_status([:assured])
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
    ...
    RuleBuilder.new(pid, "filter", "FORWARD", family: :inet)
    |> RuleBuilder.match_ct_status([:dnat])
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
    ...
    RuleBuilder.new(pid, "mangle", "PREROUTING", family: :inet)
    |> RuleBuilder.match_ct_status([:confirmed])
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
    ...
    RuleBuilder.new(pid, "filter", "FORWARD", family: :inet)
    |> RuleBuilder.match_ct_status([:dying])
    |> RuleBuilder.log("CONN-DYING: ")
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
  ...
  defp connection_marking(pid) do
    ...
    |> RuleBuilder.match_iif("lan0")
    |> RuleBuilder.match_ct_state([:new])
    |> RuleBuilder.match_connmark(0)  # Unmarked connections
    |> RuleBuilder.set_connmark(@mark_wan0)
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
    ...
    RuleBuilder.new(pid, "mangle", "PREROUTING", family: :inet)
    |> RuleBuilder.match_iif("lan0")
    |> RuleBuilder.match_dest_ip("192.168.1.0/24")
    |> RuleBuilder.match_ct_state([:new])
    |> RuleBuilder.set_connmark(@mark_local)
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
  ...
  defp mark_restoration(pid) do
    ...
    |> RuleBuilder.match_ct_state([:established, :related])
    |> RuleBuilder.match_connmark(@mark_wan0)
    |> RuleBuilder.set_mark(@mark_wan0)
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
    ...
    RuleBuilder.new(pid, "mangle", "PREROUTING", family: :inet)
    |> RuleBuilder.match_ct_state([:established, :related])
    |> RuleBuilder.match_connmark(@mark_wan1)
    |> RuleBuilder.set_mark(@mark_wan1)
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
    ...
    RuleBuilder.new(pid, "mangle", "PREROUTING", family: :inet)
    |> RuleBuilder.match_ct_state([:new])
    |> RuleBuilder.match_mark(@mark_wan0)
    |> RuleBuilder.set_connmark(@mark_wan0)
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
    ...
    RuleBuilder.new(pid, "mangle", "PREROUTING", family: :inet)
    |> RuleBuilder.match_ct_state([:new])
    |> RuleBuilder.match_mark(@mark_wan1)
    |> RuleBuilder.set_connmark(@mark_wan1)
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
  ...
  defp wan_selection(pid) do
    ...
    RuleBuilder.new(pid, "nat", "POSTROUTING", family: :inet)
    |> RuleBuilder.match_oif("wan0")
    |> RuleBuilder.match_mark(@mark_wan0)
    ...
    RuleBuilder.new(pid, "nat", "POSTROUTING", family: :inet)
    |> RuleBuilder.match_mark(@mark_local)
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
  ...
  defp failover_detection(pid) do
    ...
    RuleBuilder.new(pid, "filter", "FORWARD", family: :inet)
    |> RuleBuilder.match_ct_state([:established])
    |> RuleBuilder.match_ct_status([:assured])  # Only log assured connections
    |> RuleBuilder.rate_limit(10, :second)
    |> RuleBuilder.log("CONN-CHECK: ")
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
    |> RuleBuilder.commit()
    ...
    RuleBuilder.new(pid, "mangle", "OUTPUT", family: :inet)
    |> RuleBuilder.match_oif("wan0")
    |> RuleBuilder.match_ct_state([:new])
    |> RuleBuilder.counter()
    |> RuleBuilder.accept()
